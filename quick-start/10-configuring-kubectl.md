...
```
{
  ...
  kubectl config set-cluster onpremnetes-the-hard-way \
  ...
  kubectl config set-context onpremnetes-the-hard-way \
    --cluster=onpremnetes-the-hard-way \
    --user=admin

  kubectl config use-context onpremnetes-the-hard-way
}
...
worker-1   NotReady    <none>   118s   v1.18.0
worker-2   NotReady    <none>   118s   v1.18.0
```
