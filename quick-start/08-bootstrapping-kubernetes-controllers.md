...
In this section you will provision an external load balancer to front the Kubernetes API Servers. The `onpremnetes-the-hard-way` static IP address will be attached to the resulting load balancer.
...
frontend onpremnetes
    bind 192.168.5.30:6443
    option tcplog
    mode tcp
    default_backend onpremnetes-master-nodes

backend onpremnetes-master-nodes
    mode tcp
    balance roundrobin
    option tcp-check
