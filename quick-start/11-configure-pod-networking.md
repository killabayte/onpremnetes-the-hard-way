...
`wget https://github.com/containernetworking/plugins/releases/download/v0.8.6/cni-plugins-amd64-v0.8.6.tgz`

Extract it to /opt/cni/bin directory

`sudo tar -xzvf cni-plugins-amd64-v0.8.6.tgz  --directory /opt/cni/bin/`
