...
```
kubectl create secret generic onpremnetes-the-hard-way \
  --from-literal="mykey=mydata"
```

Print a hexdump of the `onpremnetes-the-hard-way` secret stored in etcd:
...
sudo ETCDCTL_API=3 etcdctl get \
  ...
  /registry/secrets/default/onpremnetes-the-hard-way | hexdump -C
```
...
Cleanup:
`kubectl delete secret onpremnetes-the-hard-way`
